...
class HomeView extends GetView<HomeController> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Obx(() => BlurryModalProgressHUD(
                            ...
                            children: [
                              Stack(
                                children: [
                                  ...
                                  Container(
                                    margin:
                                        EdgeInsets.only(left: 50.w, top: 17.h),
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(
                                      controller.smoke != null &&
                                              controller.smoke > 200
                                          ? 'smoke detected'
                                          : 'No smoke',
                                      style: GoogleFonts.montserrat(
                                          fontWeight: FontWeight.w600,
